...
class Data(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        label = Image.fromarray(label,mode='RGB')
...
class Encoder(nn.Module):
  def __init__(self):
    ...
    self.layer1 = ConvBNLReLU(in_channels=64, n=64, s=2) #16x16
    self.layer2 = ConvBNLReLU(in_channels=64, n=128, s=1)
    self.layer3 = ConvBNLReLU(in_channels=128, n=128, s=2) #8x8
    self.layer4 = ConvBNLReLU(in_channels=128, n=256, s=1)
    self.layer5 = ConvBNLReLU(in_channels=256, n=256, s=2) #4x4
    self.layer6 = ConvBNLReLU(in_channels=256, n=512, s=1)
    self.layer7 = ConvBNLReLU(in_channels=512, n=512, s=2) #2x2
